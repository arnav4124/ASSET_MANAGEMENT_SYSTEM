...
const ViewPendingMaintenance = () => {
        ...
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(
                    "http://localhost:3487/api/admin/assets/pending-maintenance",
                    {
                        headers: { token },
                    }
                );
    ...
    const filteredAssets = maintenanceAssets.filter(
        (asset) =>
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div className="mb-4 text-sm text-gray-600">
                            Found {filteredAssets.length} assets under maintenance
                        </div>
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {filteredAssets.length > 0 ? (
                                            filteredAssets.map((asset) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <button
                                                            onClick={() => navigate(`/admin/assets/edit-maintenance/${asset.asset_id}`)}
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    No assets found under maintenance
                                                </td>
                                            </tr>
                                        )}
                                    </tbody>
...
export default ViewPendingMaintenance; 