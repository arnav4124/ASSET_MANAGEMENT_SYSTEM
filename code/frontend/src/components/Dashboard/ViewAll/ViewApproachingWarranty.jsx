        ...
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(
                    "http://localhost:3487/api/admin/assets/approaching-warranty",
                    {
                        headers: { token },
                    }
                );
                ...
                setError("Failed to load assets with approaching warranty. Please try again.");
            } finally {
                setLoading(false);
            }
        };
                ...
                <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between">
                    <div className="flex items-center mb-4 md:mb-0">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900">
                            Assets with Approaching Warranty Expiry
                        </h1>
                    </div>
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div className="mb-4 text-sm text-gray-600">
                            Found {filteredAssets.length} assets with warranties expiring soon
                        </div>
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {filteredAssets.length > 0 ? (
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    No assets found with approaching warranty expiry
                                                </td>
                                            </tr>
                                        )}
                                    </tbody>
...
export default ViewApproachingWarranty; 